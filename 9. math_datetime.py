...
# Assignments
# -----------
# Assignment 1: Write a function that calculates compound interest using the formula A = P(1 + r/n)^(nt).def compound_interest(principal, rate, time, periods):
...
# Assignment 2: Create a script that prints the current time and updates every second.import datetime
import time
